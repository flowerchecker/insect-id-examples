...
print(entity_details)   # {'common_names': ['Harlekin-Marienkäfer', 'Vielfarbiger Marienkäfer', 'Asiatischer
# Marienkäfer'], 'url': 'https://de.wikipedia.org/wiki/Asiatischer_Marienkäfer', 'description': {'value': 'Der
# Asiatische Marienkäfer (Harmonia axyridis, auch „Vielfarbiger“ oder „Harlekin-Marienkäfer“) ist ein Käfer aus der
# Familie der Marienkäfer (Coccinellidae).\nUrsprünglich kommt die Art aus Asien und wurde Ende des 20. Jahrhunderts
# zunächst in die USA und dann auch nach Europa zur biologischen Schädlingsbekämpfung eingeführt. Inzwischen tritt
# der Käfer an vielen Stellen massenhaft wild auf, und man befürchtet, dass er einheimische Marienkäferarten und auch
# andere Insektenarten verdrängt. Im Herbst kann er Immobilienbesitzern lästig werden, da er dann Schwärme bildet,
# die zur Überwinterung Häuser und andere geschützte Orte aufsuchen.', 'citation':
# 'https://de.wikipedia.org/wiki/Asiatischer_Marienkäfer', 'license_name': 'CC BY-SA 3.0', 'license_url':
# 'https://creativecommons.org/licenses/by-sa/3.0/'}, 'image': {'value':
# 'https://insect-id.ams3.cdn.digitaloceanspaces.com/knowledge_base/wikispecies/bd2
# /bd277ab6c571f84e7db39af05084ff6fc73d1da8.jpg', 'citation':
# '//commons.wikimedia.org/w/index.php?title=User:TheBookdetective&action=edit&redlink=1', 'license_name': 'CC BY-SA
# 4.0', 'license_url': 'https://creativecommons.org/licenses/by-sa/4.0/'}, 'language': 'de', 'entity_id':
